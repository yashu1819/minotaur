...
/**
 * \file RoundingHeur.h
 * \brief Define the class RoundingHeur derived from base class Heuristics.
 * \author Prashant Palkar, IIT Delhi
 *
 * Declares the class RoundingHeur.
 */
 
#ifndef MINOTAURROUNDINGHEUR_H
#define MINOTAURROUNDINGHEUR_H
...
namespace Minotaur {
  ...
  class RoundingHeur : public Heuristic {
  public:

    /// default constructor
    RoundingHeur(EnvPtr env, ProblemPtr p, EnginePtr e);
  ...
  protected:
    ...
    typedef UInt (RoundingHeur::*FuncPtr) (UInt numfrac, const double* x,
                                             Direction d, Order o,
                                             ProblemPtr p,
                                             UIntVector& violated,
  ...
  typedef RoundingHeur* RoundingHeurPtr;
}
#endif
